...
class Genre(models.Model):
    name_genre = models.CharField(max_length=100, verbose_name='Название жанра', blank=True)
...
class Category(models.Model):
    name_сategory = models.CharField(max_length=100, verbose_name='Название категории', blank=True)
